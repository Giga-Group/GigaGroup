...
const Management = [
    {
        ...
        title: 'President and Chairman Giga Group of Companies',
    ...
    },
    {
        ...
        title: 'Vice-Chairman and CEO Giga Group',
    ...
    },
    {
        ...
        paragraphs: [
            ...
            'Mr. Amir Amin Pardesi, the elder son of Mr. Haji Amin Pardesi is a passionate entrepreneur – who is determined to change the dimensions of Real Estate development with high-value, modern lifestyles, and immaculate designs. Under his competent leadership supported by Haji Amin Pardesi, Mazyood Giga International put itself on track to deliver award-winning high-risers in Dubai. He is considered as the Dark Horse of Giga Group when it comes to lifestyle designing and building unique infrastructures.',
            'Mr. Amir Amin came to Pakistan with a vision of transforming lives and to facilitate the clients with unbeatable real estate services. With his vision of promoting skilled youth in Pakistan he started the campaign of Local Got Talent (LGT). LGT covers the twin cities and welcomes all those skilled individuals who are struggling to find a platform to promote their abilities. It also helps the users to find the right person for the right job. LGT is a win-win initiative for people belonging to every walk of life.',
            'After delivering success icons to the world of real estate in Dubai and Islamabad, Mr. Amir Amin is all set to do wonders in Karachi. He along with his team of Giga Group Karachi are bringing Goldcrest Bay Sands with three high-rise towers on prime location of sea view. Mr. Amir Amin has proven his mettle to achieve wonders for Giga Group and aspired to achieve more. He is currently Vice-chairman and CEO of Giga Group Karachi.'
        ]
    }
]
