                ...
                <div className="row">
                    <div className="col col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                        <div className="widget about-widget">   
                            ...
                            <p>Giga Group Islamabad is a leading real estate developer with 70+ years of excellence. Creating iconic developments from luxury residences to world-class commercial spaces across Pakistan and the UAE.</p>
                            <ul>
                                <li>
                        ...
                        <div className="widget wpo-service-link-widget">
                            ...
                            <div className="contact-ft">
                                <ul>
                                    ...
                                    Phase II G.T Road, Islamabad</li>
            ...
            <div className="container">
                <div className="row">
                    <div className="col col-xs-12">
                        <ul>
                            <li>@2025 Giga Group. All Rights Reserved.</li>
